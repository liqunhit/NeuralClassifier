...
class SumAttention(torch.nn.Module):
    ...
    def __init__(self, input_dimension, attention_dimension, dropout=0):
        ...
        self.attention_matrix = \
            init_tensor(torch.empty(input_dimension, attention_dimension))
        self.bias = torch.zeros(attention_dimension)
        self.attention_vector = init_tensor(torch.empty(attention_dimension, 1))
